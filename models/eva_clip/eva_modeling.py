...
#
# WETGHT_PATH = {
#             "EVA02-CLIP-L-14": '/root/autodl-tmp/pretrained_models/clip/EVA02_CLIP_L_psz14_s4B.pt',
#             "EVA02-CLIP-L-14-336": '/root/autodl-tmp/pretrained_models/clip/EVA02_CLIP_L_336_psz14_s6B.pt',
#             "EVA02-CLIP-bigE-14":'/root/autodl-tmp/pretrained_models/clip/EVA02_CLIP_E_psz14_s4B.pt',
#             "EVA02-CLIP-bigE-14-plus":'/root/autodl-tmp/pretrained_models/clip/EVA02_CLIP_E_psz14_plus_s9B.pt'
#         }


WETGHT_PATH = {
            "EVA02-CLIP-L-14": '/home/tzj/pretrained_models/clip/EVA02_CLIP_L_psz14_s4B.pt',
            "EVA02-CLIP-L-14-336": '/home/tzj/pretrained_models/clip/EVA02_CLIP_L_336_psz14_s6B.pt',
            "EVA02-CLIP-bigE-14":'/home/tzj/pretrained_models/clip/EVA02_CLIP_E_psz14_s4B.pt',
            "EVA02-CLIP-bigE-14-plus":'/home/tzj/pretrained_models/clip/EVA02_CLIP_E_psz14_plus_s9B.pt'
        }
...
class CLIP4CLIP(nn.Module):
    ...
    def wti_interaction(self, text_feat, video_feat, text_mask, video_mask):
        # if self.training and torch.cuda.is_available():  # batch merge here  TODO
