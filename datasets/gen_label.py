...
def gen_sth_label(data_path, ann_path, out_path, source='rgb'):
    ...
    def parse_video_file(file):
        ...
        return folders, idx_categories   # 找出每个 folder 对应的 类别id

    if 'sthv1' in ann_path:
        dataset_name = 'something-something-v1'
        data_path = osp.join(data_path, '20bn-something-something-v1')
        ...
        # data_path = osp.join(data_path, '20bn-something-something-v2')
        data_path = osp.join(data_path, '20bn-something-something-v2-frames')
...
def main():
    ...
    ann_path = osp.join(args.data_path, args.ann_root, args.dataset)
    out_path = osp.join(args.data_path, args.out_root, args.dataset)
